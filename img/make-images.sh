...
# for the README.md only homework01, seminar-paper01, slides01, exam03, minutes01 and essay01 are needed
...
# minutes01, pages 1-3
typst c --root .. ../examples/minutes01.typ  "./minutes01-{0p}.png" --format png --pages 1-3
